...
import { IsString, IsArray, IsUrl, MaxLength, ArrayMaxSize, IsOptional } from 'class-validator';
...
export class UpdateAlertDto {
    @ApiPropertyOptional({
        ...
        example: 'Updated: Friendly golden retriever, responds to "Max". Now wearing a red collar.'
    })
    @IsOptional()
    @IsString()
    @MaxLength(2000)
