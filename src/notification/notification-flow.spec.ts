...
import { NotificationConfidence, NotificationStatus } from '../generated/prisma';
...
describe('Notification Flow (e2e)', () => {
    ...
    beforeEach(async () => {
        ...
        queueProcessor = module.get<NotificationQueueProcessor>(NotificationQueueProcessor);
    });
    ...
    describe('Complete notification flow', () => {
        ...
        it('should process alert and queue individual notifications', async () => {
            ...
            (prismaService.alert.findUnique as jest.Mock).mockResolvedValue(mockAlert);
            (locationService.findDevicesForAlert as jest.Mock).mockResolvedValue(mockDevices);
        ...
        it('should send FCM notification for Android device', async () => {
            ...
            (prismaService.notification.findUnique as jest.Mock).mockResolvedValue(mockNotification);
        ...
        it('should handle push notification failure', async () => {
            ...
            await expect(queueProcessor.process(job)).rejects.toThrow('Failed to send push notification: INVALID_TOKEN');
