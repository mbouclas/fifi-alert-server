    ...
    private async initialize(): Promise<void> {
        try {
            ...
            try {
                ...
                this.logger.error(`APNs key file not found at ${keyPath}. iOS notifications disabled.`);
                return;
            }
            ...
            this.logger.warn('Failed to initialize APNs provider. iOS notifications disabled.');
