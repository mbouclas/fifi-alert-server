...
describe('UploadService', () => {
    ...
    describe('uploadImage', () => {
        ...
        it('should upload a valid JPEG image', async () => {
            ...
            expect(mockStorageStrategy.getPublicUrl).toHaveBeenCalledWith('alerts/123456-dog.jpg');
        });

        it('should upload a valid PNG image', async () => {
            const file = createMockFile(3 * 1024 * 1024, 'image/png', 'cat.png');
            const expectedUrl = 'http://localhost:3000/uploads/sightings/123456-cat.png';
        ...
        it('should upload a valid WEBP image', async () => {
            ...
            mockStorageStrategy.getPublicUrl.mockReturnValue('http://localhost:3000/uploads/alerts/123456-pet.webp');
        ...
        it('should upload a valid HEIC image', async () => {
            ...
            mockStorageStrategy.getPublicUrl.mockReturnValue('http://localhost:3000/uploads/alerts/123456-iphone.heic');
        ...
        it('should throw BadRequestException for invalid file type', async () => {
            const file = createMockFile(1 * 1024 * 1024, 'application/pdf', 'document.pdf');
        ...
        it('should throw BadRequestException for executable files', async () => {
            const file = createMockFile(1 * 1024 * 1024, 'application/x-msdownload', 'malware.exe');
        ...
        it('should reject file at exactly max size + 1 byte', async () => {
            const file = createMockFile(10 * 1024 * 1024 + 1, 'image/jpeg', 'exactly-over.jpg');
        ...
        it('should accept file at exactly max size', async () => {
            const file = createMockFile(10 * 1024 * 1024, 'image/jpeg', 'exactly-max.jpg');
            mockStorageStrategy.upload.mockResolvedValue('alerts/123456-exactly-max.jpg');
            mockStorageStrategy.getPublicUrl.mockReturnValue('http://localhost:3000/uploads/alerts/123456-exactly-max.jpg');
    ...
    describe('uploadImages', () => {
        ...
        it('should upload multiple valid images', async () => {
            ...
            mockStorageStrategy.upload.mockResolvedValueOnce('alerts/123456-photo1.jpg')
            ...
            mockStorageStrategy.getPublicUrl
                .mockReturnValueOnce('http://localhost:3000/uploads/alerts/123456-photo1.jpg')
                .mockReturnValueOnce('http://localhost:3000/uploads/alerts/123457-photo2.jpg')
                .mockReturnValueOnce('http://localhost:3000/uploads/alerts/123458-photo3.jpg');
        ...
        it('should upload exactly 5 files (max limit)', async () => {
            ...
            mockStorageStrategy.getPublicUrl.mockReturnValue('http://localhost:3000/uploads/alerts/123456-photo.jpg');
        ...
        it('should upload files in parallel (Promise.all)', async () => {
            ...
            mockStorageStrategy.getPublicUrl.mockReturnValue('http://localhost:3000/uploads/alerts/photo.jpg');
    ...
    describe('deleteFile', () => {
        it('should delete file by full URL', async () => {
            ...
            expect(mockStorageStrategy.delete).toHaveBeenCalledWith('alerts/123456-dog.jpg');
        });
        ...
        it('should delete file by relative path', async () => {
            ...
            expect(mockStorageStrategy.delete).toHaveBeenCalledWith('sightings/123456-cat.jpg');
        });
        ...
        it('should handle URL with query parameters (strips them)', async () => {
            ...
            expect(mockStorageStrategy.delete).toHaveBeenCalledWith('alerts/photo.jpg?v=123');
        });
